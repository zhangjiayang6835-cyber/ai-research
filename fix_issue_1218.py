"""Fix for Issue #1218: OAuth Access Token in Referer Header → Token Leak"""
import re
...
if __name__ == "__main__":
    ...
    assert result["data"]["headers"].get("Referrer-Policy") == "strict-origin-when-cross-origin"
    print("✓ Referrer-Policy header set to strict-origin-when-cross-origin")
    ...
    print("\n✅ All tests passed for #1218: OAuth Referer Leak Fix")
